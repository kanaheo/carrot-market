  ...
  return (
    <div className="bg-slate-400 py-20 px-20 grid gap-10 min-h-screen">
      ...
      <div className="bg-white p-6 rounded-2xl shadow-2xl">
        {/* 🔙 의자 이미지 https://i.ibb.co/5963kz8/chair.jpg */}
        ...
        <div className="flex flex-col">
          ...
          <div className="mt-3 mb-5 flex justify-between items-center">
            ...
            <div className="flex items-center space-x-5">
              <button className="p-1.5 rounded-lg bg-blue-200 flex justify-center items-center aspect-square w-8 text-gray-500">
                -
              </button>
              <span>1</span>
              <button className="p-1.5 rounded-lg bg-blue-200 flex justify-center items-center aspect-square w-8 text-gray-500">
          ...
          <div className="flex justify-between items-center">
            ...
            <button
              className="bg-blue-500 py-2 px-8 text-center text-xs
